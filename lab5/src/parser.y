...
%nterm <stmttype> Stmts Stmt AssignStmt BlockStmt IfStmt ReturnStmt ContinueStmt BreakStmt  DeclStmt FuncDef IdDeclLists IdDeclList ConstDeclLists ConstDeclList WhileStmt FuncFParam FuncFParams FuncCallStmt EmptyStmt
%nterm <exprtype> Exp AddExp Cond LOrExp PrimaryExp LVal RelExp LAndExp InitVal MulExp UnaryExp EqExp FuncRParams
%nterm <type> Type
